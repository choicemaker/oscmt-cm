...
import com.choicemaker.cm.custom.mci.gend.internal.MciRecords.flatfile.*;
import com.choicemaker.cm.io.blocking.automated.base.*;
import com.choicemaker.cm.custom.mci.gend.internal.MciRecords.blocking.*;
import com.choicemaker.cm.io.xml.base.*;
import com.choicemaker.cm.custom.mci.gend.internal.MciRecords.xml.*;
import com.choicemaker.cm.io.xml.base.*;
import com.choicemaker.cm.io.xml.base.*;
import com.choicemaker.cm.io.db.base.*;
import com.choicemaker.cm.custom.mci.gend.internal.MciRecords.db.*;
...
return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.flatfile.MciRecordsSingleFileFlatFileReader((Tokenizer)tokenizer, tagged, singleLine);
}
public Object getMultiFileFlatFileReader(Object tokenizer, boolean tagged) {
return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.flatfile.MciRecordsMultiFileFlatFileReader((Tokenizer[])tokenizer, tagged);
}
...
return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.flatfile.MciRecordsFlatFileRecordOutputter(multiFile, singleLine, fixedLength, sep, tagged, tagWidth, filter);
}
public Object getBlockingConfiguration(String name, String dbConf) {
if("batch".equals(name)) return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.blocking.MciRecords__batch__BlockingConfiguration(dbConf);
if("initialVital".equals(name)) return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.blocking.MciRecords__initialVital__BlockingConfiguration(dbConf);
if("interactive".equals(name)) return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.blocking.MciRecords__interactive__BlockingConfiguration(dbConf);
return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.blocking.MciRecords__batch__BlockingConfiguration(dbConf);
}
...
return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.xml.MciRecordsXmlReader();
}
...
xmlRecordOutputter = new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.xml.MciRecordsXmlRecordOutputter();
}
...
reportOutputter = new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.MciRecordsXmlReporter();
}
...
if("patient".equals(name)) return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.db.MciRecords__patient__DbReaderParallel();
return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.db.MciRecords__patient__DbReaderParallel();
}
public Object getDbReaderSequential(String name) {
if("patient".equals(name)) return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.db.MciRecords__patient__DbReaderSequential();
return new com.choicemaker.cm.custom.mci.gend.internal.MciRecords.db.MciRecords__patient__DbReaderSequential();
}
