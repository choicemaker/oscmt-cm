...
private static Logger logger = Logger.getLogger(com.choicemaker.cm.custom.mci.gend.internal.MciRecords.AddressImpl.class.getName());
...
__v_street_name = Validators.isValid("mciStreetNameValidator",street_name);
