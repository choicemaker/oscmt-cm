 ...
 */
public class PatientRecordHolder implements com.choicemaker.cm.testobjects.mci.MciRecords.IPatientRecordHolder, java.io.Serializable, com.choicemaker.cm.core.Identifiable<Integer> {
/** Default constructor. Initializes all all arrays for nested record to zero length arrays and all other values to their defaults (0/null). */public PatientRecordHolder() {
...
*/
public PatientRecordHolder(PatientBase __o) {
