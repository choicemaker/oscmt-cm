...
import java.util.*;
public final class MciRecordsXmlReporter implements XmlRecordOutputter {
private static Logger logger = Logger.getLogger(com.choicemaker.cm.custom.mci.gend.internal.MciRecords.MciRecordsXmlReporter.class.getName());
