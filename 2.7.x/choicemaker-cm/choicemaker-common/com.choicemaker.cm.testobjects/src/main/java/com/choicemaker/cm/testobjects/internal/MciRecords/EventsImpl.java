...
private static Logger logger = Logger.getLogger(com.choicemaker.cm.custom.mci.gend.internal.MciRecords.EventsImpl.class.getName());
...
disease_cd = CdssDiseaseUtils.fastDecryptHealthEventDiseaseCode(event_id);
__v_disease_cd = Sets.includes("diseaseCodes", disease_cd);
}
} else {
__v_disease_cd = Sets.includes("diseaseCodes", disease_cd);
}
