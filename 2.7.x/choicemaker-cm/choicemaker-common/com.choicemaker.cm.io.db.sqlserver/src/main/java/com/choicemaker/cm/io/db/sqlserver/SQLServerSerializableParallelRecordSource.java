 ...
 *
 */
public class SQLServerSerializableParallelRecordSource implements
		ISerializableDbRecordSource {
	
	private static final long serialVersionUID = 271L;

	private static final Logger log = Logger
			.getLogger(SQLServerSerializableParallelRecordSource.class.getName());
...
//	private String dsMapName;
	 ...
	 * </pre>
	 */
	public SQLServerSerializableParallelRecordSource(String dsJNDIName,
	...
	public boolean equals (Object o) {
		if (o instanceof SQLServerSerializableParallelRecordSource) {
			SQLServerSerializableParallelRecordSource rs =
				(SQLServerSerializableParallelRecordSource) o;
