 ...
 * </ul>
 * <p>
 * <strong>Staging deduplication</strong>
 * </p>
 * <p>
 * In this type of a job, a single record source is matched against itself. The
 * OABA service finds duplicate records within the source.
 * </p>
 * <p>
 * <strong>Staging to master linkage</strong>
 * </p>
 * <p>
 ...
 * itself, whereas the master source is assumed to be already de-duplicated. The
 * OABA service finds duplicate records within the staging source and between
 * the staging source and the master source. The OABA service does not look for
 * duplicates within the master source.
 * </p>
 * <p>
 * <strong>Master to master linkage</strong>
 * </p>
 * <p>
...
public enum OabaLinkageType {
	...
	public static boolean isLinkage(OabaLinkageType task) {
		boolean isLinkage;
		switch (task) {
