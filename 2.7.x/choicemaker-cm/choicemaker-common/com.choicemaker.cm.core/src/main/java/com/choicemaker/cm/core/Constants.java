...
public final class Constants {
	...
	public static final String MODELS_DIRECTORY = "etc" + File.separator
			+ "models";

	/**
	 * The directory where model-specific objects (such as a JAR file of holder
	 * classes or a script to create database views) are created, relative to
	 * the {@link #MODELS_DIRECTORY}
	 */
	public static final String GEN_OUT_DIRECTORY = "gen/out";
	...
	/**
	 * The directory in which marked record pair descriptors are stored, e.g.,
	 * etc/traindata.
	 */
	public static final String TRAINDATA_DIRECTORY = "etc" + File.separator
			+ "traindata";
	...
	public static final String LAYOUT_DIRECTORY = "etc" + File.separator
			+ "layouts";
	...
	public static final String ENCRYPTED_XML_EXTENSION = "xmlenc";
