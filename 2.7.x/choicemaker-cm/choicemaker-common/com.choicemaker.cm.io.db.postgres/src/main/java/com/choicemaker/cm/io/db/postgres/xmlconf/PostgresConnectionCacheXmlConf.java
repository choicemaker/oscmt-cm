...
/**
 * XML configurator for Postgres Connection Cache.
 *
 * @author Martin Buechi (original version)
 * @author rphall (rewrote for ODJBC6/UCP)
 */
public class PostgresConnectionCacheXmlConf {

	private static Logger logger = Logger
			.getLogger(PostgresConnectionCacheXmlConf.class.getName());
	...
	public static final String DEFAULT_CONNECTION_FACTORY_CLASS_NAME = "FIXME";
	...
	public static DataSource getConnectionCache(String name,
		...
		if (cc != null) {
			...
			Element e = XmlConfigurator.getInstance().getPlugin("postgres");
			if (e != null) {
				@SuppressWarnings("rawtypes")
				List children = e.getChildren("PostgresConnectionCache");
	...
	public static String createJdbcUrl(String host, int port, String database) {
		...
		StringBuilder sb = new StringBuilder("jdbc:postgres:@");
