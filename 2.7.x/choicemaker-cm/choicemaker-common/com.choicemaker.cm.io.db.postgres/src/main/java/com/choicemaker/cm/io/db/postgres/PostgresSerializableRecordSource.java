...
/**
 * This is a wrapper object around Postgres PostgresRecordSource and it can be
...
public class PostgresSerializableRecordSource implements
	...
	private transient PostgresRecordSource sqlRS;
	private transient DataSource ds;
	private transient ImmutableProbabilityModel model;

	public PostgresSerializableRecordSource(
		String dsJNDIName,
		String modelName,
		String dbConfig,
		String sqlQuery) {
	...
	private PostgresRecordSource getRS () {
		if (sqlRS == null) {
			sqlRS = new PostgresRecordSource ();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PostgresSerializableRecordSource other =
			(PostgresSerializableRecordSource) obj;
		if (getDbConfig() == null) {
	...
	public String toString() {
		return "PostgresSerializableRecordSource [dsJNDIName=" + dsJNDIName
