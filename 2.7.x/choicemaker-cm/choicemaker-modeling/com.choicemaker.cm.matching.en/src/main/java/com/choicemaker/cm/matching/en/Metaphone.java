...
/**
 * Metaphone (Philips 1990) is another phoneticization algorithm. It works 
...
public class Metaphone {
	 ...
	 * @return the Metaphone encoding for txt
	 */
	public static String metaphone(String txt) {
		...
		int n = 0;
		while ((mtsz < MAX_CODE_LEN) && // max code size of 4 works well
		 (n < wdsz)) {
