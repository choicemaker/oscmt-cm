...
public class Matcher {
	...
	public synchronized void setDone(boolean done) {
		...
		this.done = done;
		firePropertyChange(DONE, Boolean.valueOf(oldValue), Boolean.valueOf(done));
	}
	...
	public void setNumPairs(int numPairs) {
		...
		firePropertyChange(NUM_PAIRS, new Integer(oldValue), new Integer(numPairs));
	}
	...
	public void setNumRecordsFromLarge(int numRecordsFromLarge) {
		...
		firePropertyChange(
			NUM_RECORDS_FROM_LARGE,
			new Integer(oldValue),
			new Integer(numRecordsFromLarge));
	}
	...
	public void setNumRecordsFromSmall(int numRecordsFromSmall) {
		...
		firePropertyChange(
			NUM_RECORDS_FROM_SMALL,
			new Integer(oldValue),
			new Integer(numRecordsFromSmall));
	}
}
