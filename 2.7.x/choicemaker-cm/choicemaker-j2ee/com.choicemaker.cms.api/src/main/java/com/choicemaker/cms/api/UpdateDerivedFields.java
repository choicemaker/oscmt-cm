 ...
 * @author rphall
 */
public interface UpdateDerivedFields {
	 ...
	 * productionProbabilityModels section of a project configuration file (e.g.
	 * project.xml).
	 * </p>
	 * <p>
	 * If a model configuration does not define an implementation of this
	 * interface, then a default, DoNothing implementation is invoked where
	 * needed.
	 */
	// Avoid dependence on com.choicemaker.cm.core package
	// String PN_MODEL_CONFIGURATION_UPDATOR_DELEGATE =
	 ...
	 * they should trigger the stored procedures to recalculate all derived
	 * fields on all records and then return a non-zero count of the records
	 * that were updated.
	 * </p>
	 *
	 * @param dataSource
	 ...
	 * derived fields may implement a NOP method that returns zero. Otherwise
	 * they should trigger the stored procedures to recalculate all derived
	 * fields on the specified record and then return a count of 1 (one).
	 * </p>
	 *
	 ...
	 * 
	 * @param id
	 *            the key that identifies the record that should be updated.
	 * 
	 * @return the number of records for which derived fields were updated (0 or
	 *         1 expected)
	 * 
