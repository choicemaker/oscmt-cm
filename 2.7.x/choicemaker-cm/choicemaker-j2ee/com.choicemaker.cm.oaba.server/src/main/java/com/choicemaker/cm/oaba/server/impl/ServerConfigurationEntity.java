...
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.CN_CONFIGNAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.CN_FILE;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.CN_HOSTNAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.CN_ID;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.CN_MAXCHUNKCOUNT;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.CN_MAXCHUNKSIZE;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.CN_MAXTHREADS;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.CN_UUID;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.ID_GENERATOR_NAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.ID_GENERATOR_PK_COLUMN_NAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.ID_GENERATOR_PK_COLUMN_VALUE;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.ID_GENERATOR_TABLE;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.ID_GENERATOR_VALUE_COLUMN_NAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.JPQL_SERVERCONFIG_FIND_ALL;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.JPQL_SERVERCONFIG_FIND_BY_HOSTNAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.JPQL_SERVERCONFIG_FIND_BY_NAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.QN_SERVERCONFIG_FIND_ALL;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.QN_SERVERCONFIG_FIND_BY_HOSTNAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.QN_SERVERCONFIG_FIND_BY_NAME;
import static com.choicemaker.cm.oaba.server.impl.ServerConfigurationJPA.TABLE_NAME;
...
import com.choicemaker.cm.oaba.server.ejb.MutableServerConfiguration;
