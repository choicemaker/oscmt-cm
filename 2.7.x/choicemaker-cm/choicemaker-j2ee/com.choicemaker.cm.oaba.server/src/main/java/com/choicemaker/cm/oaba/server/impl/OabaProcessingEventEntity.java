...
import static com.choicemaker.cm.oaba.server.impl.OabaProcessingEventJPA.DISCRIMINATOR_VALUE;
import static com.choicemaker.cm.oaba.server.impl.OabaProcessingEventJPA.JPQL_OABAPROCESSING_DELETE_BY_JOBID;
import static com.choicemaker.cm.oaba.server.impl.OabaProcessingEventJPA.JPQL_OABAPROCESSING_FIND_ALL;
import static com.choicemaker.cm.oaba.server.impl.OabaProcessingEventJPA.JPQL_OABAPROCESSING_FIND_BY_JOBID;
import static com.choicemaker.cm.oaba.server.impl.OabaProcessingEventJPA.QN_OABAPROCESSING_DELETE_BY_JOBID;
import static com.choicemaker.cm.oaba.server.impl.OabaProcessingEventJPA.QN_OABAPROCESSING_FIND_ALL;
import static com.choicemaker.cm.oaba.server.impl.OabaProcessingEventJPA.QN_OABAPROCESSING_FIND_BY_JOBID;
...
import com.choicemaker.cm.oaba.server.ejb.OabaBatchProcessingEvent;
