...
public class BlockStatistics {
	...
	// this keep track of which blocking field combinations are most oftenly
	// used.
	private HashMap useBlockingFields = new HashMap();

	// this variable keeps track on block size distribution.
	// distribution[i] counts the number of blocks with size > i*step and <=
	// (i+1)*step.
	...
	/**
	 * This method returns the block size distribution. distribution[i] counts
	 * the number of blocks with size > i*10 and <= (i+1)*10.
	 * 
	...
	/**
	 * This method returns a hashmap containing blocking field combinations and
	 * the frequency they appear in the blocks.
	 * 
