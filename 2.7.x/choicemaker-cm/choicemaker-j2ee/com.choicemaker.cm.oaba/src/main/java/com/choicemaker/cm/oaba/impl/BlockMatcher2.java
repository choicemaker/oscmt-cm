...
import com.choicemaker.cm.oaba.core.IBlockMatcher2;
...
public class BlockMatcher2<T extends Comparable<T>> implements
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.choicemaker.cm.oaba.core.IBlockMatcher#
	 * matchBlocks
	 * (com.choicemaker.cm.oaba.core.IBlockSource,
	 * com.choicemaker.cm.core.base.ProbabilityModel,
	 * com.choicemaker.cm.core.base.RecordSource,
	 * com.choicemaker.cm.oaba.core.IMatchRecordSink,
	 * float, float, int)
	 */
	@Override
