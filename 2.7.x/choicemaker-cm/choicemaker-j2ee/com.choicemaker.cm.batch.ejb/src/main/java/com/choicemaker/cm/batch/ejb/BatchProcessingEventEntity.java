...
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.CN_EVENT_INFO;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.CN_EVENT_NAME;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.CN_EVENT_SEQNUM;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.CN_EVENT_TIMESTAMP;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.CN_EVENT_TYPE;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.CN_FRACTION_COMPLETE;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.CN_ID;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.CN_JOB_ID;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.DISCRIMINATOR_COLUMN;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.DISCRIMINATOR_VALUE;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.ID_GENERATOR_NAME;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.ID_GENERATOR_PK_COLUMN_NAME;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.ID_GENERATOR_PK_COLUMN_VALUE;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.ID_GENERATOR_TABLE;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.ID_GENERATOR_VALUE_COLUMN_NAME;
import static com.choicemaker.cm.batch.ejb.BatchProcessingEventJPA.TABLE_NAME;
