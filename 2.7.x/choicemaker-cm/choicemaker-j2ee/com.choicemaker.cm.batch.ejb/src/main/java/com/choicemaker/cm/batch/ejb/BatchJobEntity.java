...
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_DESCRIPTION;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_EXTERNAL_ID;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_ID;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_PARAMS_ID;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_RIGOR;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_SERVER_ID;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_SETTINGS_ID;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_STATUS;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_TIMESTAMP;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_TRANSACTION_ID;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_TYPE;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.CN_WORKING_DIRECTORY;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.DISCRIMINATOR_COLUMN;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.DISCRIMINATOR_VALUE;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.ID_GENERATOR_NAME;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.ID_GENERATOR_PK_COLUMN_NAME;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.ID_GENERATOR_PK_COLUMN_VALUE;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.ID_GENERATOR_TABLE;
import static com.choicemaker.cm.batch.ejb.BatchJobJPA.ID_GENERATOR_VALUE_COLUMN_NAME;
