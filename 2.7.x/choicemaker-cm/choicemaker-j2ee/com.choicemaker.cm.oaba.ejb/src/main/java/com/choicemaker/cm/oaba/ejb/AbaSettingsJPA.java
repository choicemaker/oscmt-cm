...
public interface AbaSettingsJPA {
	...
	String CN_ABA_MAX_MATCHES = "ABA_MAX_MATCHES";
	String CN_ABA_LIMIT_BLOCKSET = "LIMIT_BLOCKSET";
	String CN_ABA_LIMIT_SINGLESET = "LIMIT_SINGLESET";
	String CN_ABA_LIMIT_SINGLETABLE = "LIMIT_SINGLETABLE";
