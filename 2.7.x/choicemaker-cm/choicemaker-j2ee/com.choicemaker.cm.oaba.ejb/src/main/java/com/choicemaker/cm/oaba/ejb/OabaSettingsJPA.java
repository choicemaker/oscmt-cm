...
public interface OabaSettingsJPA {
	...
	String CN_OABA_MAX_BLOCKSIZE = "MAX_BLOCKSIZE";
	String CN_OABA_MAX_CHUNKSIZE = "MAX_CHUNKSIZE";
	String CN_OABA_MAX_OVERSIZE = "MAX_OVERSIZE";
	String CN_OABA_MAX_MATCHES = "MAX_MATCHES";
	String CN_OABA_MIN_FIELDS = "MIN_FIELDS";
	String CN_OABA_INTERVAL = "INTERVAL";
