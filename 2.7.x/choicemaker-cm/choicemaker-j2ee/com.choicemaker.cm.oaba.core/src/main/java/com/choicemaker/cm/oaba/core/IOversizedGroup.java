...
/**
 * This interface handles the writing of oversized blocks. It manages where a
 * oversized block is written to based on the maximum column id of the oversized
 * block.
 * 
 * @author pcheung
 *
...
public interface IOversizedGroup {
	...
	/**
	 * This method writes the oversized block set to the appropiate file/table
	 * based on the maximum column id of the block set.
	 * 
	 * @param bs
	 * @throws IOException
	 */
	...
	/**
	 * This method returns the correct set of oversized block set with the same
	 * maxColumn.
	 * 
	 * @param maxColumn
	 *            - maximum column id of the bloct sets
	 */
