...
public interface IOABAProperties extends Serializable {
	...
	/**
	 * This defines which oversized blocks to keep. If an oversized block has
	 * more elements than getMaxOversized, then it is thrown away.
	 * 
	 * @return int
	 */
	...
	/**
	 * This defines which oversized blocks to keep. If an oversized block was
	 * created from N number of columns (or fields) and N is less than
	 * getMinFields, then it is thrown away.
	 * 
	 * @return int
	 */
	...
	/**
	 * This returns the maximum number of chunk data files to create at once. If
	 * there are 1000 chunk files and getMaxChunkFiles is 800, then OABA reads
	 * through the record source twice. The pass creates 800 chunk data files
	 * and the second pass creates 200 chunk data files.
	 * 
	 * This is necessary because the OS has a limit on how many files can be
	 * opened at once.
	 * 
	 * @return int
	 */
