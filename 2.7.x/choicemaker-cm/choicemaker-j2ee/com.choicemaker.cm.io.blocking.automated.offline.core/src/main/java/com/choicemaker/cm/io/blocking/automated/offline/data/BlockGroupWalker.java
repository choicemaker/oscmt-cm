 ...
 * 
 * If the BlockGroup has N files and interval is I, the first call returns
 * indexes (N-I+1) to N. The next call is (N-2I+1) to (N-I). In general, the nth
 * call produces indexes in (N-nI+1) to (N-(n-1)I).
 * 
 * @author pcheung
 *
 */
public class BlockGroupWalker {
	...
	/**
	 * This returns the start index and end index for this interval. The first
	 * call returns (N-I+1) and N. The second call returns (N-2I+1) and (N-I).
