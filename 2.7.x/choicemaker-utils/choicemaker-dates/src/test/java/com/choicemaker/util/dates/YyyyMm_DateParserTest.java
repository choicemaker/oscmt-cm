...
public class YyyyMm_DateParserTest {

	private static final Logger logger = Logger
			.getLogger(YyyyMm_DateParserTest.class.getName());

	static final YearMonthDay YYYYMM_196809 = new YearMonthDay(1968, 9,
			YearMonthDay.PLACEHOLDER_DAY);
	static final YearMonthDay YYYYMM_196824 = new YearMonthDay(1968, 24,
			YearMonthDay.PLACEHOLDER_DAY);
	...
	static final InputAndExpectedYMD[] TESTS_PARSE = new InputAndExpectedYMD[] {
			...
			new InputAndExpectedYMD("196809", YYYYMM_196809),
			...
			new InputAndExpectedYMD("196824", YYYYMM_196824),
	...
	public void testParse() {
		IDateParser parser = new YyyyMm_DateParser();
