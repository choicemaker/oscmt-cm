/*******************************************************************************
 * Copyright (c) 2016, 2020 ChoiceMaker LLC and others.
...
import static com.choicemaker.cms.client.app.URM_BMA_APP_COMMAND.*;
import static com.choicemaker.cms.client.util.APP_SERVER_VENDOR.*;
...
public class UrmCommandLine {
	...
	public static final String COMMAND_LINE = String.format(COMMAND_LINE0,
			com.choicemaker.cms.client.app.UrmBmaApp.class.getName());
