...
package com.choicemaker.demo.simple_person_matching.gendata.gend.internal.Person.blocking;
...
public final class Person__defaultAutomated__BlockingConfiguration extends BlockingConfiguration {
private static Logger logger = Logger.getLogger(com.choicemaker.demo.simple_person_matching.gendata.gend.internal.Person.blocking.Person__defaultAutomated__BlockingConfiguration.class.getName());
public Person__defaultAutomated__BlockingConfiguration(String dbConf) {
int dbConfIndex;
