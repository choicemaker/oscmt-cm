...
package com.choicemaker.demo.simple_person_matching.gendata.gend.internal.Person.db;
...
public final class Person__default__DbReaderParallel implements DbReaderParallel {
private static Logger logger = Logger.getLogger(com.choicemaker.demo.simple_person_matching.gendata.gend.internal.Person.db.Person__default__DbReaderParallel.class.getName());
private ResultSet[] rs;
private static DerivedSource src = DerivedSource.valueOf("db");
public String getName() {
return "Person:r:default";
}
