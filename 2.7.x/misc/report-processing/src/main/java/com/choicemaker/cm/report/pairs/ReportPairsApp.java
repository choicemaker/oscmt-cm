...
public class ReportPairsApp {

	static final Logger logger = Logger.getLogger(ReportPairsApp.class.getName());
	...
	public static void main(String[] args) throws Exception {
		...
		logger.fine("ReportPairsApp (main) args: " + Arrays.toString(args));
