...
public class ClueMakerMojoTest extends AbstractMojoTestCase {

	private static final Logger logger = Logger.getLogger(ClueMakerMojoTest.class.getName());

	protected static final String TEST_PROJECT_PATH = "src/test/resources/cluemaker/";
	...
	public void testConfiguration() throws Exception {
		...
		for (String p : POMS) {
			...
			// Load the Mojo
			ClueMakerMojo myMojo = (ClueMakerMojo) this.lookupConfiguredMojo(project,
					"generate");
			...
			try {
				...
				// cluemaker-maven-plugin-it for a (slow) integration test that
