...
import static com.choicemaker.cmit.io.db.sqlserver.SqlServerRecordSourceApp.COUNT_RECORDS_BETWEEN_DEBUG_PRINTS;
import static com.choicemaker.cmit.io.db.sqlserver.SqlServerRecordSourceApp.COUNT_RECORDS_BETWEEN_INFO_PRINTS;
...
public class AbstractSqlServerRecordSourceApp<T extends Comparable<T>> {
	...
	public static <T extends Comparable<T>> void logRecord(int count,
			Record<T> r) {
		SqlServerParallelRecordSourceApp.logRecord(count, r,
