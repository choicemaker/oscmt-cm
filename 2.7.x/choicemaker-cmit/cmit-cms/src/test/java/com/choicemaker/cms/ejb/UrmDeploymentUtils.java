...
import static com.choicemaker.cms.ejb.NamedConfigConstants.CURRENT_MAVEN_COORDINATES;
import static com.choicemaker.cms.ejb.NamedConfigConstants.PERSISTENCE_CONFIGURATION;
...
public class UrmDeploymentUtils {
	
	public static final String REGEX_EJB_DEPENDENCIES =
		"com.choicemaker.cm.oaba.ejb.*.jar"
...
//				+ "|cmit-server-transitivity-it.*.jar"
	...
	public static EnterpriseArchive createEarArchive(Class<?>[] removedClasses,
		...
		final Pattern p =
			Pattern.compile(UrmDeploymentUtils.REGEX_EJB_DEPENDENCIES);
