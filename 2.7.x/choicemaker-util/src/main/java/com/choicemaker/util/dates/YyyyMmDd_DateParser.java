...
public final class YyyyMmDd_DateParser extends AbstractDateParser {
	...
	public static final String REGEX_YYYYMMDD =
		"^(\\d{4,4})(\\d{2,2})(\\d{2,2})$";
	...
	private static AtomicReference<Pattern> YYYYMMDD_PATTERN =
	...
	public Pattern getPattern() {
		...
		boolean wasNull =
			YYYYMMDD_PATTERN.compareAndSet(null,
					Pattern.compile(REGEX_YYYYMMDD));
		if (wasNull) {
			String msg =
				"Compiled the standard date pattern from '" + REGEX_YYYYMMDD
						+ "'";
			logger.info(msg);
		}
