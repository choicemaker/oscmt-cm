...
public interface CMConfigurationElement {
	/**
	 * Creates and returns a new instance of the executable extension identified
	 * by the named attribute of this configuration element. The named attribute
	 * value must contain a fully qualified name of a Java class implementing
	 ...
	 * <code>setInitializationData</code> is called, passing to the object the
	 * configuration information that was used to create it.
	 * </p>
	 * <p>
	 ...
	 * <p>
	 * The names of configuration element attributes are the same as the
	 * attribute names of the corresponding XML element. For example, the
	 ...
	 * configuration element. Returns an empty array if this configuration
	...
	/**
	 * Returns the name of this configuration element. The name of a
	 * configuration element is the same as the XML tag of the corresponding XML
	 * element. For example, the configuration markup
	 * 
	 * <pre>
	 ...
	 * <p>
	 * Values may span multiple lines (i.e., contain carriage returns and/or
	 * line feeds).
	 * <p>
	 * Note that any translation specified in the plug-in manifest file is
	 * automatically applied.
	 ...
	 * line feeds).
	 * <p>
	 * Note that translation specified in the plug-in manifest file is
	 * <b>not</b> automatically applied. For example, the configuration markup
	 * 
	 * <pre>
