...
public interface CMPluginRegistry {
	 ...
	 */
	public CMConfigurationElement[] getConfigurationElementsFor(String extensionPointId);
	/**
	 * Returns all configuration elements from all extensions configured
	 * into the identified extension point. Returns an empty array if the extension 
	 * point does not exist, has no extensions configured, or none of the extensions 
	 ...
	 * @return the configuration elements
	 */
	public CMConfigurationElement[] getConfigurationElementsFor(String pluginId, String extensionPointName);
	/**
	 ...
	 * @return the extension, or <code>null</code>
	 */
	public CMExtension getExtension(String pluginId, String extensionPointName, String extensionId);
	/**
	 ...
	 * @return the extension point, or <code>null</code>
	 */
	public CMExtensionPoint getExtensionPoint(String pluginId, String extensionPointName);
	/**
