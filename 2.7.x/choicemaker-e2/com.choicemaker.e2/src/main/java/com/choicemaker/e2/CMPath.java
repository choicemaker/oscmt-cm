 ...
 * @see Path
 */
public interface CMPath extends Cloneable {
	 ...
	 * <code>/</code> or <code>C:/</code>, is considered absolute.
	 * </p>
	 *
	 ...
	 * <p>
	 * The root path is the absolute path with zero segments; e.g.,
	 ...
	 * device id is the prefix up to and including the first ":"; the path
	 * proper is everything to the right of it, or the entire string if there is
	 * no ":". The device id is not checked for validity; the path proper is
	 ...
	 * <li>any string starting or ending with a whitespace character is not
	 * valid
	 ...
	 * segments in this path, an empty path is returned.
	 * </p>
	 *
	 * @return the new path
	 */
