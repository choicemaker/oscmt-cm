 ...
 * @see #getPlugin
 */
public interface CMPluginDescriptor {
	/**
	 ...
	 * the location provided by Plugin#getStateLocation.
	 *
	...
	/**
	 * Returns the plug-in runtime object corresponding to this plug-in
	 * descriptor. Unlike other methods on this object, invoking this method may
	 * activate the plug-in. The returned object is an instance of the plug-in
	 * runtime class specified in the plug-in's manifest file; if a class is not
	 * specified there, the returned object is an internally-supplied one that
	 * does not react to life cycle requests.
	 *
	 ...
	 * this plug-in. The class loader can be used to directly access plug-in
	 * resources and classes. Note that accessing a resource will <b>not
	 * activate</b> the corresponding plug-in. Successfully loading a class will
	 * <b>always activate</b> the corresponding plug-in.
	 * <p>
	 ...
	 *
	 * // Load a resource bundle. May, or may not activate the plug-in,
	 * // depending
	 * // on the bundle implementation. If implemented as a class, the plug-in
	 * // will be activated. If implemented as a properties file, the plug-in
	 * // will
	 * // not be activated.
	 * ResourceBundle b =
	...
	/**
	 * Returns a list of plug-in prerequisites required for correct execution of
	 * this plug-in.
	 *
	 * @return an array of plug-in prerequisites, or an empty array if no
	 ...
	 * the plug-in manifest file (<code>plugin.xml</code>) along with other
	 ...
	 * a string begining with the "%" character. Note, that the "%" character is
	...
	// * could not be computed or created.
	// *
	// * find will look for this path under the directory structure for this
	// plugin
