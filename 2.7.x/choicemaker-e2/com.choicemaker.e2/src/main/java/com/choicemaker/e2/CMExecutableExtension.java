 ...
 */
public interface CMExecutableExtension {
	/**
	 * This method is called by the implementation of the method
	 * <code>CMConfigurationElement.createExecutableExtension</code> on a newly
	 ...
	 * <p>
	 * Regular executable extensions specify their Java implementation class
	 * name as an attribute of the configuration element for the extension. For
	 * example
	 * 
	 * <pre>
	 ...
	 * <code>&lt;action&gt;</code> element (first argument), and
	 * <code>"run"</code> as the name of the attribute that defined this
	 * executable extension (second argument).
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * There are two supported ways of associating additional adapter-specific
	 * data with the configuration in a way that is transparent to the extension
	 * point implementor:
	 * </p>
	 * <p>
	 * (1) by specifying adapter data as part of the implementation class
	 * attribute value. The Java class name can be followed by a ":" separator,
	 * followed by any adapter data in string form. For example, if the
	 * extension point specifies an attribute <code>"run"</code> to contain the
	 * name of the extension implementation, an adapter can be configured as
	 * 
	 * <pre>
	 ...
	 * </p>
	 * <p>
	 * (2) by converting the attribute used to specify the executable extension
	 * to a child element of the original configuration element, and specifying
	 * the adapter data in the form of xml markup. Using this form, the example
	 * above would become
	 * 
	 * <pre>
	 *     &lt;action&gt;
	 ...
	 * </p>
	 * <p>
	 * Form (2) will typically only be used for extension points that anticipate
	 * the majority of extensions configured into it will in fact be in the form
	 * of adapters.
	 * </p>
	 * <p>
	 ...
	 * argument of this method. The data argument is defined as Object. It can
	 ...
	 * <code>Hashtable</code> containing the actual parameter names and values
	 * (both <code>String</code>s)</li>
	 * </ul>
	 * </p>
	 *
	 * @param config
