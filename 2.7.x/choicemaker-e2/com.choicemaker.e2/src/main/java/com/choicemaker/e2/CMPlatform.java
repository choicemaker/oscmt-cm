...
public interface CMPlatform {
	...
	// public static final String PLUGINS_FILE = PLUGIN_BASE_DIR +
	// "/plugins.xml";
	...
	// /**
	// * Status code constant (value 2) indicating an error occurred while
	// running a plug-in.
	// */
	...
	URL getPluginDescriptorUrl(String id, String version,
