...
public interface CMPluginVersionIdentifier {
	 ...
	 * its service component is greater than the argument service component, or
	 * the major, minor and service components are equal and the qualifier
	 * component is greated than the argument qualifier component (using
	 * lexicographic string comparison), or all components are equal.
	 * </p>
	 *
	 * @param versionId
	 *            the other version identifier
	 * @return <code>true</code> is this version identifier is compatible with
	 *         the given version identifier, and <code>false</code> otherwise
	 * @since 2.0
	 */
	boolean isGreaterOrEqualTo(CMPluginVersionIdentifier id);
	 ...
	 * components are equal, than the service level of the version identifier
	 * must be greater than or equal to the service level of the argument
	 * identifier. If the service levels are equal, the two version identifiers
	 * are considered to be equivalent if this qualifier is greated or equal to
	 * the qualifier of the argument (using lexicographic string comparison).
	 * </p>
	 *
	 * @param versionId
	 *            the other version identifier
	 ...
	 *         the given version identifier, and <code>false</code> otherwise
	 */
	boolean isCompatibleWith(CMPluginVersionIdentifier id);

	/**
	 * Compares two version identifiers for equivalency.
	 * <p>
	 * Two version identifiers are considered to be equivalent if their major
	 * and minor component equal and are at least at the same service level as
	 * the argument. If the service levels are equal, the two version
	 * identifiers are considered to be equivalent if this qualifier is greated
	 * or equal to the qualifier of the argument (using lexicographic string
	 * comparison).
	 * 
	 * </p>
	 *
	 ...
	 */
	boolean isEquivalentTo(CMPluginVersionIdentifier id);
	 ...
	 * @param versionId
	 *            the other version identifier
	 * @return <code>true</code> is this version identifier is perfectly equal
	 *         to the given version identifier, and <code>false</code> otherwise
	 * @since 2.0
	 */
	boolean isPerfect(CMPluginVersionIdentifier id);
	 ...
	 *         given version identifier, and <code>false</code> otherwise
	 */
	boolean isGreaterThan(CMPluginVersionIdentifier id);
